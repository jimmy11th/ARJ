      ...
      <Stack gap={0} my={0}>
        ...
        >
          ...
          <Typography variant="body1" gutterBottom align="center" width="80%">
            We are a trusted brand for athletes and fitness enthusiasts looking for the highest quality supplements to
            optimize their workouts and achieve their fitness goals. Our product ingredients are of the purest quality,
            meet pharmaceutical grade, and are lab-tested.
          </Typography>
        </Box>
        <LabTabs />
